<template>
  <v-app class="mainContainer">
    ...
    <p class="order">
      Here is what you ordered from {{ this.cook.name }}:
      <a>
    ...
    <p class="venmoText">
      You can make a Venmo payment
      of <span><b>${{ this.total }}</b></span> to <br>
      <a v-if="this.cook.venmoLink" class="venmoText">
        <v-btn
          href="https://urlgeni.us/venmo/bicky-singh"
          elevation="2"
          color="#3d95ce"
          width="180"
        >
      ...
      <a v-if="!this.cook.venmoLink">
        <b>{{ this.cook.venmo }}</b>
        .
      </a>
    </p>

    <!-- <div v-if="this.cook.venmoLink" class="venmoText">
              <v-btn
  href="https://urlgeni.us/venmo/bicky-singh"
  elevation="2"
  color="#3d95ce"
  width="180"
><b>{{this.cook.venmo}}</b></v-btn>
            </div> -->
